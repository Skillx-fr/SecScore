...
export function QuestionWizard({ theme, onAnswer, onRemoveAnswer, onFinish }) {
            ...
            <div className="space-y-4">
                <AnimatePresence mode="wait">
                    {question.options.map((option, idx) => {
                        ...
                        const feedbackStyle = showFeedback && isSelected ? getRiskColor(option.riskLevel) : 'border-slate-700 hover:bg-skillx/20';
            ...
            <div className="h-20 mt-8 flex justify-end items-center">
                {showFeedback && (
                    <motion.button
                        ...
                        onClick={handleNext}
                        className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-skillx text-white rounded-full font-semibold shadow-lg shadow-blue-500/25 transition-all"
                    >
